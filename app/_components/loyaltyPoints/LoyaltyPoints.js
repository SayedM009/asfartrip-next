...
export default function LoyaltyPoints({ price }) {
    ...
    return (
        <div className="flex items-center gap-1 py-0.5 pl-2 pr-1 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900 dark:to-green-300 rounded-2xl rounded-bl-2xl">
            ...
            <span
                ...
                dangerouslySetInnerHTML={{
                    __html: l.rich("inline_points", {
                        bold: (chunks) =>
                            `<span class='font-bold text-sm'>${chunks}</span>`,
                        points: points,
                    }),
                }}
            />
...
//     const { config, fetchConfig, calculatePoints, isLoading } =
//         useLoyaltyStore();
...
//         };
//         load();
//     }, [price, config, fetchConfig, calculatePoints]);
