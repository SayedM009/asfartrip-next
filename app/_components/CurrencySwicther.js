...
function CurrencySwicther({ hiddenOnMobile = false }) {
  ...
  const currencies = [
    ...
    { code: "GBP", name: t("CurrencySwitcher.currencies.gbp"), symbol: "£" },
    { code: "CHF", name: t("CurrencySwitcher.currencies.chf"), symbol: "CHF" },
    { code: "AED", name: t("CurrencySwitcher.currencies.ae"), symbol: "AED" },
  ];
