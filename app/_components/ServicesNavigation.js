            ...
            {SERVICES.map((service, index) => (
                <motion.div
                    ...
                    <Link
                        ...
                        className={clsx(
                            "flex justify-start flex-col sm:min-w-40 items-center",
                        ...
                        <div className="relative pointer-events-none">
                            ...
                            {service.soon && (
                                <span className="absolute -bottom-2.5 right-[50%] translate-x-1/2 sm:top-0 sm:bottom-auto sm:-right-25 sm:rtl:-left-25 sm:rtl:right-auto   px-1.5 py-0.5 text-xs font-semibold rounded-full text-white animate-pulse bg-gradient-to-r from-amber-500 via-pink-500 to-purple-500">
                                    {t("soon")}
                                </span>
                            )}
                        </div>
