...
import FareSummaryDialog from "@/app/_modules/flight/booking/components/organism/FareSummaryDialog";

export default function HotelPaymentSection({
    onConfirmPayment,
    backTo,
    loading,
    iframeSrc,
    ...
    return (
        <div className="space-y-6 flex-1 mt-1">
            ...
            {/* Gateways — same layout as flight */}
            <GateWays
...
function PaymentButton({ onConfirmPayment, loading, isTelrCard, totalAmount }) {
