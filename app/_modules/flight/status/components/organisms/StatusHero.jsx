        ...
        >
            ...
            <div className="relative z-10 flex flex-col sm:flex-row sm:justify-between sm:items-center">
                <div className="flex items-center sm:flex-row sm:items-center gap-2 mb-4 ">
                    <Icon
                        className={`sm:w-16 sm:h-16 w-8 h-8 ${iconColor} flex-shrink-0 text-center`}
                    />
                    <div className="sm:flex-1">
                        <div className="flex items-center gap-3">
                            <h1 className="text-lg sm:text-3xl font-bold text-gray-900 dark:text-white flex gap-2 items-center md:flex-col md:items-start ">
