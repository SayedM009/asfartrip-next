...
export default function PaymentDetails({ payment }) {
    ...
    const { card_type, card_last4, payment_status, transaction_date } = payment;

    // Format card number display with last 4 digits
    const cardNumber = card_last4 ? `•••• ${card_last4}` : "N/A";

    return (
        <div className="py-4 px-6 rounded-2xl  border border-gray-200 dark:border-gray-700 flex-1">
            ...
            <div className="flex flex-col gap-3">
                ...
                {card_type && <InfoRow label={t("method")} value={card_type} />}
