...
export default function CardPaymentDetails({ payment }) {
    ...
    return (
        <div className="py-4 px-6 rounded-2xl  border border-gray-200 dark:border-blue-700 flex-1">
            ...
            <div className="flex flex-col gap-3">
                {card_type && (
                    <InfoRow label={t("card_type")} value={card_type} />
                )}

                {cardDisplay && (
                    <InfoRow label={t("payment_method")} value={cardDisplay} />
                )}
                ...
                {displayDate && (
                    <InfoRow label={t("payment_date")} value={displayDate} />
                )}
            </div>
        </div>
    );
