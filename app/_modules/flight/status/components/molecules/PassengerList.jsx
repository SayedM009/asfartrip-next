...
export default function PassengerList({ passengers }) {
    ...
    return (
        <div className="space-y-4 flex-1  border border-gray-200 dark:border-gray-700 py-4 px-6 rounded-2xl">
                ...
                {passengers.map((passenger, index) => (
                    ...
                    >
                        ...
                        <span className="px-2 py-1 rounded-lg bg-accent/20 text-gray-900 dark:text-white font-semibold text-xs uppercase">
                            #{passenger.travelerNumber || index + 1}{" "}
                            {passenger.title}
                        </span>
                        ...
                        <span className="font-medium text-gray-900 dark:text-white capitalize">
                            {t(
                                passenger.travelerType?.toLowerCase() || "adult"
                            )}
                        </span>
                    </motion.div>
                ))}
